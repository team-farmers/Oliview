...
-- 샘플 댓글 데이터 모두 삭제
DELETE FROM "COMMENT"
WHERE COMMENT_NO BETWEEN 1 AND 37;
...
SELECT DISTINCT 
		...
		WHERE OPEN_MEMBER = 41 OR PARTICIPANT = 41
		AND	BOARD_DEL_FL = 'N' 
...
DELETE FROM "MEMBER"
WHERE MEMBER_NO IN 6;

DELETE FROM MESSAGE
WHERE SENDER_NO  IN 4;

DELETE FROM CHATTING_ROOM cr 
WHERE OPEN_MEMBER  IN 4;

DELETE FROM CHATTING_ROOM cr 
WHERE PARTICIPANT  IN 4;
