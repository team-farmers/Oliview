...
SELECT REVIEW_TITLE, REVIEW_IMG, WRITE_DATE
FROM (SELECT REVIEW_TITLE, REVIEW_IMG, WRITE_DATE, 
	RANK() OVER(PARTITION BY REVIEW_TITLE ORDER BY WRITE_DATE DESC) AS rn 
	FROM "REVIEW")
WHERE REVIEW_TITLE ='서브웨이'
AND rn =1;
