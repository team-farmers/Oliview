...
import com.farmers.oliview.email.model.mapper.EmailMapper;
	   ...
	   public int sendEmail(String htmlName, String email) {
	       //6자리 난수 인증번호 생성
	        ...
	        try {
	           ...
	           switch(htmlName) {
	           case "signup" : subject = "[Oliview] 회원가입 인증 번호 입니다."; break;
	           case "findPw" : subject = "[Oliview] 비밀번호 찾기 인증 번호 입니다."; break;
	           }
