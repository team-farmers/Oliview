...
const sortLatestFn = (cp) => {
  ...
  .then((map) => {
    ...
    a1.addEventListener("click", () => sortLatestFn(1));
    a1.innerHTML = "&lt;&lt;";
    li1.append(a1);
    ...
    a2.innerHTML = "&lt;";
    a2.addEventListener("click", () => sortLatestFn(pg.prevPage));
    li2.append(a2);
    ...
    for(let i = pg.startPage; i<=pg.endPage; i++){
      ...
      a.addEventListener("click", () => sortLatestFn(i));
      a.innerHTML = i;
    ...
    a3.addEventListener("click", () => sortLatestFn(pg.nextPage));
    a3.innerHTML = "&gt;";
    li3.append(a3);
    ...
    // a1.setAttribute("onclick", "sortLatestFn(1)");
    a4.addEventListener("click", () => sortLatestFn(pg.maxPage));
    a4.innerHTML = "&gt;&gt;";
    li4.append(a4);
...
const sortRatingFn = (cp) => {
  ...
  .then((map) => {
    ...
    const a1 = document.createElement("a");
    // a1.setAttribute("onclick", "sortLatestFn(1)");
    a1.addEventListener("click", () => sortRatingFn(1));
    a1.innerHTML = "&lt;&lt;";
    li1.append(a1);
    ...
    const a2 = document.createElement("a");
    a2.innerHTML = "&lt;";
    a2.addEventListener("click", () => sortRatingFn(pg.prevPage));
    li2.append(a2);
    ...
    for(let i = pg.startPage; i<=pg.endPage; i++){
      const li = document.createElement("li");
      const a = document.createElement("a");
      a.addEventListener("click", () => sortRatingFn(i));
      a.innerHTML = i;
    ...
    const li3 = document.createElement("li");
    const a3 = document.createElement("a");
    a3.addEventListener("click", () => sortRatingFn(pg.nextPage));
    a3.innerHTML = "&gt;";
    li3.append(a3);
    ...
    const a4 = document.createElement("a");
    // a1.setAttribute("onclick", "sortLatestFn(1)");
    a4.addEventListener("click", () => sortRatingFn(pg.maxPage));
    a4.innerHTML = "&gt;&gt;";
    li4.append(a4);
